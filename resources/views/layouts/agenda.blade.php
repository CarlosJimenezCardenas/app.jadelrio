...
<html lang="en">
    ...
    <script>
      $(document).ready( function () {
          ...
          /*$('#menu').click(function(){
            $("#forma").prop("method","POST");
            $("#forma").prop("action","/respuestaLoginBotonMenu");
            $('#forma').submit();

            $("#form").prop("method","GET");
            $("#form").prop("action","https://127.0.0.1:8009");
            $('#form').submit();
...
<body>
      <form name='forms' id='forms' method="POST" action="">
        ...
        <header style="position:absolute;top:-1%;left:-1%;z-index:99999;">
          <div class="smm">
            <div class="row">
              <div class="col-lg-8 col-md-7 col-sm-5 col-10 smm__container js-smm-container">
              ...
              <div class="d-none d-sm-block col-lg-4 col-md-4 col-sm-5 text-right" style="padding:20px">
                <?PHP echo "<font color='white' size='1px'>".session('nombreUsuario')."</font>";?></br>
