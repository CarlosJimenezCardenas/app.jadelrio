...
<html>
	<head>
		...
		<script src="../js/agenda/oficinas/Mexico/Leon/Leon/leon/leon.js"></script>
			...
			<div class="col-lg-12" style="position:absolute;top:13%;z-index:0;height:20%">
				<div class="row">
					...
					<div style="position:relative; text-align:center;" class="col-lg-12 col-md-12 col-sm-12 col-12">
						...
						<map name="mapa">
							<!--SALA DE JUNTAS-->				
							<area id="uno" href="javascript:eligeOficina(<?PHP echo $_POST['idPiso'];?>,1,<?PHP echo $_POST['sucursal'];?>,'Sala de juntas');" shape="rect" coords="240,4,397,110">
							
							<!--OFICINA 1-->				
							<area id="dos" href="javascript:eligeOficina(<?PHP echo $_POST['idPiso'];?>,2,<?PHP echo $_POST['sucursal'];?>,'Oficina 1');" shape="rect" coords="282,311,402,416">

							<!--MIGUEL PEÑALOZA-->				
							<area id="tres" shape="rect" coords="128,3,239,112">

							<!--SITE-->				
							<area id="cuatro" shape="rect" coords="153,417,217,495">

							<!--ARCHIVO-->				
							<area id="cinco" shape="rect" coords="278,112,399,241">

							<!--Recepcion-->				
							<area id="seis" shape="rect" coords="27,419,151,494">
						</map>
					</div>
				</div>
			</div>
