        ...
        <form name="forma" id="forma" style="z-index:0">
            ...
            <div class="col-lg-12" style="position:absolute;top:13%;z-index:0;height:20%">
                ...
                <div class="col-lg-12 col-md-12 col-sm=12 col-12">
                    <?PHP echo "<center>".$datosSeparados[2]."-".$datosSeparados[3]."-".$datosSeparados[4]."-".$datosSeparados[5]."-".$_POST['nombreOficina']."</center>";?>
                </div>
            ...
            $(document).ready(function () {
                ...
                var calendar = $('#calendar').fullCalendar({
                    ...
                    eventClick:function(event)
                    {
                        swal({
                            title: "Estas seguro?",
                            text: "Una vez eliminada, liberaras esta oficina y podrá ser tomada por alguien más!",
                            icon: "warning",
                            buttons: true,
                            dangerMode: true,
                        })
