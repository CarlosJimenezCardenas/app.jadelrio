$(document).ready( function () {
    $( "#uno" ).easyTooltip({xOffset: 100, yOffset: 100, tooltipDir: "right", content: "Pedro Rosales"});
    ...
    $( "#tres" ).easyTooltip({
        ...
        yOffset: 100,
        tooltipDir: "right",
        content: "Javier Corona"
    });   

    $( "#cuatro" ).easyTooltip({xOffset: 100, yOffset: 100, tooltipDir: "right", content: "Dolores"});
    $( "#cinco" ).easyTooltip({xOffset: 100, yOffset: 100, tooltipDir: "right", content: "Sala B"});
    ...
    $( "#veintidos" ).easyTooltip({ xOffset: 100, yOffset: 100, tooltipDir: "right",  content: "Sala D" });
